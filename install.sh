...
grant_permission "settings put secure enabled_accessibility_services com.mapcontrol/.GlobalBackService" "AccessibilityService"
grant_permission "cmd accessibility enable-service com.mapcontrol/.GlobalBackService" "AccessibilityService (cmd)"
